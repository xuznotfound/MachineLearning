#python train_anime_dcgan_tuned.py --batch-size 256 --workers 32 --epochs 500 --save-every 20
import argparse
import os
import random
...
def parse_args():
    parser = argparse.ArgumentParser(description="DCGAN training on Anime Face dataset (tuned checkpoints)")
    parser.add_argument("--batch-size", type=int, default=256, help="Batch size for training")
    parser.add_argument("--workers", type=int, default=min(32, os.cpu_count() or 8), help="Dataloader workers")
    ...
    parser.add_argument("--g-lr", dest="g_lr", type=float, default=0.0001, help="Generator learning rate")
    parser.add_argument("--d-lr", dest="d_lr", type=float, default=0.0002, help="Discriminator learning rate")
    parser.add_argument("--beta1", type=float, default=0.5, help="Adam beta1")
    parser.add_argument("--epochs", type=int, default=120, help="Number of training epochs")
    parser.add_argument("--output-dir", type=str, default="outputs_tuned", help="Directory to save checkpoints and samples")
    ...
    parser.add_argument("--save-every", type=int, default=10, help="Save samples and checkpoints every N epochs")
    parser.add_argument("--d-steps", dest="d_steps", type=int, default=2, help="Discriminator steps per generator step")
    parser.add_argument("--real-label", dest="real_label", type=float, default=0.9, help="Label smoothing for real images")
